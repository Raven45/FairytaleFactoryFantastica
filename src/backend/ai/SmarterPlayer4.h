#ifndef SMARTERPLAYER4_H
#define SMARTERPLAYER4_H
...
class SmarterPlayer4 : public Player {
...
public:
    ...
    SmarterPlayer4():moveCount(0),isFirstMove(true){
            ...
            for( int pieceIndex = qrand()%9, pieceCount = 0;     pieceCount    < MAX_PIECES_ON_QUADRANT;   pieceIndex  = ((pieceIndex    == 8)? 0 : pieceIndex    + 1), ++pieceCount    ){
                ...
                if( mainBoard.holeIsEmpty( quadrantIndex, pieceIndex )){
                    ...
                    for( rotationConfig.randomize(); rotationCount < NUMBER_OF_POSSIBLE_ROTATIONS; ++rotationCount, ++rotationConfig ){
                        ...
                        if( checkWeight > bestMoveWeight && ( !test.checkWin().isDraw || bestMoveWeight == INT_MIN ) ){
                            ...
                            int ourOtherBestMoveWeight = 0;
                            int opponentsOtherBestMoveWeight = 0;
                                ...
                                for( int pieceIndexOpp = qrand()%9, pieceCountOpp = 0;     pieceCountOpp    < MAX_PIECES_ON_QUADRANT && !isTerribleMove;   pieceIndexOpp  = ((pieceIndexOpp    == 8)? 0 : pieceIndexOpp    + 1), ++pieceCountOpp    ){
                                    ...
                                    if( test.holeIsEmpty( quadrantIndexOpp, pieceIndexOpp )){
                                        ...
                                        for( rotationConfigOpp.randomize(); rotationCountOpp < NUMBER_OF_POSSIBLE_ROTATIONS; ++rotationCountOpp, ++rotationConfigOpp ){
                                            ...
                                            BitBoard mySecondLevelBoard = opponentsBoardOpp;
                                            BitBoard opponentsSecondLevelBoard = boardToRotateOpp;
                                               ...
                                               for( int quadrantIndexOpp = qrand() % 4, quadrantCountOpp = 0;  quadrantCountOpp < NUMBER_OF_QUADRANTS;    quadrantIndexOpp = ((quadrantIndexOpp == 3)? 0 : quadrantIndexOpp + 1), ++quadrantCountOpp ){
                                                   for( int pieceIndexOpp = qrand()%9, pieceCountOpp = 0;     pieceCountOpp    < MAX_PIECES_ON_QUADRANT;   pieceIndexOpp  = ((pieceIndexOpp    == 8)? 0 : pieceIndexOpp    + 1), ++pieceCountOpp    ){
                                                       ...
                                                       if( test.holeIsEmpty( quadrantIndexOpp, pieceIndexOpp )){
                                                           ...
                                                           //place the piece
                                                           BitBoard tryPieceHereOpp = mySecondLevelBoard;
                                                           tryPieceHereOpp.placePiece(quadrantIndexOpp, pieceIndexOpp);
                                                           ...
                                                           for( rotationConfigOpp.randomize(); rotationCountOpp < NUMBER_OF_POSSIBLE_ROTATIONS; ++rotationCountOpp, ++rotationConfigOpp ){
                                                               ...
                                                               BitBoard boardToRotateOpp = tryPieceHereOpp;
                                                               boardToRotateOpp.rotate( rotationConfigOpp.quadrantIndex, rotationConfigOpp.direction );
                                                               BitBoard opponentsBoardOpp = opponentsSecondLevelBoard;
                                                               opponentsBoardOpp.rotate( rotationConfigOpp.quadrantIndex, rotationConfigOpp.direction );

                                                               BitBoard oppThirdhLevelBoard = opponentsBoardOpp;
                                                               BitBoard myThirdLevelBoard = boardToRotateOpp;

                                                                Board test(boardToRotateOpp,opponentsBoardOpp, util.opposite(myColor) );



                                                               int checkWeightOpp = evaluateBitBoard( boardToRotateOpp, opponentsBoardOpp, mySecondLevelBoard );

                                                               if( checkWeightOpp > ourOtherBestMoveWeight  && ( !test.checkWin().isDraw || ourOtherBestMoveWeight == INT_MIN ) ){
                                                                  ourOtherBestMoveWeight = checkWeightOpp;

                                                                  if( test.checkWin().winner == myColor ){
                                                                      //return Turn(quadrantIndex, pieceIndex, rotationConfig.quadrantIndex, rotationConfig.direction, myColor);
                                                                      qDebug() << "Ooh, found a move that wins in two turns";
                                                                  }
                                                                  ...
                                                                  for( int quadrantIndexOpp = qrand() % 4, quadrantCountOpp = 0;  quadrantCountOpp < NUMBER_OF_QUADRANTS && !isTerribleMove;    quadrantIndexOpp = ((quadrantIndexOpp == 3)? 0 : quadrantIndexOpp + 1), ++quadrantCountOpp ){
                                                                      for( int pieceIndexOpp = qrand()%9, pieceCountOpp = 0;     pieceCountOpp    < MAX_PIECES_ON_QUADRANT && !isTerribleMove;   pieceIndexOpp  = ((pieceIndexOpp    == 8)? 0 : pieceIndexOpp    + 1), ++pieceCountOpp    ){
                                                                          ...
                                                                          if( test.holeIsEmpty( quadrantIndexOpp, pieceIndexOpp )){
                                                                              ...
                                                                              //place the piece
                                                                              BitBoard tryPieceHereOpp = oppThirdhLevelBoard;
                                                                              tryPieceHereOpp.placePiece(quadrantIndexOpp, pieceIndexOpp);
                                                                              ...
                                                                              for( rotationConfigOpp.randomize(); rotationCountOpp < NUMBER_OF_POSSIBLE_ROTATIONS; ++rotationCountOpp, ++rotationConfigOpp ){
                                                                                  ...
                                                                                  BitBoard boardToRotateOpp = tryPieceHereOpp;
                                                                                  boardToRotateOpp.rotate( rotationConfigOpp.quadrantIndex, rotationConfigOpp.direction );
                                                                                  BitBoard opponentsBoardOpp = myThirdLevelBoard;
                                                                                  opponentsBoardOpp.rotate( rotationConfigOpp.quadrantIndex, rotationConfigOpp.direction );

                                                                                  int checkWeightOpp = evaluateBitBoard( boardToRotateOpp, opponentsBoardOpp, oppThirdhLevelBoard );
                                                                                  ...
                                                                                  if( checkWeightOpp > opponentsOtherBestMoveWeight  && ( !test.checkWin().isDraw || opponentsOtherBestMoveWeight == INT_MIN ) ){
